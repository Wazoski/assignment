...
BOOL CPacketSenderDlg::OnInitDialog()
{
	...
	ctrlIP.SetAddress(ip[0],ip[1],ip[2],ip[3]);
...
/////////////////////////////////////////////////////  문제 ////////////////////////////////////////////////////
		m_S1AP->SetMessageType(0); // 다음 단계의 메세지 타입 설정
		memcpy(spayload,"",length); // 다음 단계의 ITEM 생성 함수 호출
		break;

	case S1AP_MSG_TYPE_ATTACH_ACCEPT:
		length = 32;
		items = 3;
		m_S1AP->SetTheNumberOfItems(items);

/////////////////////////////////////////////////////  문제 ////////////////////////////////////////////////////
		// Initial Context Setup Response => from eNB
		m_S1AP->SetMessageType(0); // 수정하시오.
		memcpy(spayload,"",length); // 수정하시오.
